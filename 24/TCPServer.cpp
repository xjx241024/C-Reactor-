...
void TCPServer::setOnMessageCallback(std::function<void(Connection *, std::string &message)> cb)
{
    onMessageCallback_ = cb;
}

void TCPServer::setSendCompleteCallback(std::function<void(Connection *)> cb)
{
    sendCompleteCallback_ = cb;
}

void TCPServer::setCloseConnectionCallback(std::function<void(Connection *)> cb)
{
    closeConnectionCallback_ = cb;
}

void TCPServer::setErrorConnectionCallback(std::function<void(Connection *)> cb)
{
...
void TCPServer::setNewConnectionCallback(std::function<void(Connection *)> cb)
{
